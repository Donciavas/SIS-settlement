...
namespace StudentInfoSystem_Exam
{
    public static class ConsoleMessage
    {
        public static void DisplayMainWindow()
        {
            ...
            Console.WriteLine("  4 - Create student in existing department and assign lectures");
        ...
        public static void LectureSelectionWindow(List<Lecture> dbListLecture, List<Lecture> listLectures)
        {
            ...
            Console.WriteLine("");
            Console.WriteLine($"{dbListLecture.Count + 1} - Add new lecture to department");
        ...
        public static void LectureToDepartmentsSelectionWindow(List<Department> dbListDepartment, List<Department> listDepartments)
        {
            Console.Clear();
            Console.WriteLine("");
            Console.WriteLine("Assign lecture to existing departments: ");
            Console.WriteLine("");
            ...
            Console.WriteLine("");
            Console.WriteLine("");
            Console.WriteLine("Lecture assigned to departments: ");
            Console.WriteLine("");
            foreach (var department in listDepartments)
            {
        ...
        public static void StudentSelectionWindow(List<Student> departmentSudentsList)
        {
            Console.Clear();
            Console.WriteLine("");
            Console.WriteLine("Create a new student or select student to add him lectures");
            Console.WriteLine("");
        ...
        public static void StudentLectureSelectionWindow(List<Lecture> departmentListLecture, List<Lecture> studentListLecture)
        {
            Console.Clear();
            Console.WriteLine("");
            Console.WriteLine("Add lecture to student: ");
            Console.WriteLine("");
        ...
        public static void StudentTransferSelectionWindow(List<Student> listStudents)
        {
            Console.Clear();
            Console.WriteLine("");
            Console.WriteLine("Select student from department to transfer: ");
            Console.WriteLine("");
